create table bet (id bigint not null auto_increment, bet_choice_user1 integer, bet_choice_user2 integer, match_id bigint, user1_id bigint, user2_id bigint, primary key (id)) engine=MyISAM;
...
create table friends (id bigint not null auto_increment, friends_id bigint, me_id bigint, primary key (id)) engine=MyISAM;
...
create table user_bet_history (user_id bigint not null, bet_history_id bigint not null, primary key (user_id, bet_history_id)) engine=MyISAM;
...
alter table league_matches add constraint UK_bw2qjvedqigcjdxmu2hq9e8sa unique (matches_id);
    ...
    alter table user_bet_history add constraint UK_2c6panntjkxv5w5ogsc4lxpa7 unique (bet_history_id);
    ...
    alter table friends add constraint FKhfa6fmq8olgrgufffn9fnt8qh foreign key (friends_id) references user (id);
    alter table friends add constraint FK4rcvuhlgwwjgdd3jl60gmn40e foreign key (me_id) references user (id);
    ...
    alter table user_bet_history add constraint FKcqylffnm5brx1hjn48hoho6l7 foreign key (bet_history_id) references bet (id);
    alter table user_bet_history add constraint FK2xdy6lx9w9dua4c5awwbr3oa5 foreign key (user_id) references user (id);
