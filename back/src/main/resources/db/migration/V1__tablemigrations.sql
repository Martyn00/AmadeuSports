...
create table match_entity (id bigint not null auto_increment, data varchar(255), status varchar(255), result varchar(255), duration integer not null, start_time datetime, league_id bigint, team1_id bigint, team2_id bigint, primary key (id)) engine=MyISAM;
...
create table match_event (id bigint not null auto_increment, goal integer, min integer not null, is_updated bit, primary key (id)) engine=MyISAM;
